...
package kw24.required.a4x2.stuffBeginnersDontHaveToUnderstand;
...
public class GivenCodeVersion implements Serializable {
    ...
    final static private long encodedGivenCodeVersion = 2___00002_003___2025_06_07__01L;    //### <<<=== !!! GIVEN CODE VERSION !!!
    //------------------------=======================---#---^^^^^-^^^---^^^^-^^-^^--^^      //#####################################
    //#############################################################################################################################
