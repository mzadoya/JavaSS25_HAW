...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        //also ohne com wird ein Standardverfahren für Sortierung benutzt, die für Liste spezifisch
        System.out.println(nums);
        
        
        Collections.sort(nums);  //wird wie oben gennant ist nach einem Standardsortierung sortiert 
        //(erste Zahl ist die mächtigste, 1X ist links bzw. quasi niedrigste Adresse, 9x ist quasi höchste Adresse -> rechts)
        System.out.println(nums);
        
        Comparator<Autos> comAutos = new Comparator<Autos>() {
      ...
      //  Collections.sort(autos); BUT!!! FAIl! Da sie nicht Comparible sind (Compiler weisst nicht wie er Autos vergleichen muss)
        //s. Class Houses
        ...
        //jetzt werden Houses AUTOMATISCH mit bereit in der Klasse implementierten Methode sortiert, dabei muss nicht ein
        //Comparator explizit hier geschr. werden oder als zweites Paramether uebergeben
