...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        /* 1) in Set exestieren keine Duplikaten 
         * 2) ein Element kann nicht mit nums[i] aufgerufen werden => Index funktioniert bzw. exestiert nicht!
         * 3) get und set sind auch nicht erlaubt 
         * 
        */
         ...
         * 
         * 1) werden ungeordnet gespeichert, also quasi irgendwie random mit hash of Value
         * 
         */
         ...
         * 
         * Anmerkung: sortiert heisst, dass die Elemente nach einem Prinzip sortiert werden 
         * z.B. geordnet heisst, wenn die Elemente so gespeichert werden, in welcher Reihenfolge sie hinzufügt worden sind
         * 
         * Beispiel: Arraylist: x.add("Beta") x.add("Alpha") x.add("Omega") => [Beta, Alpha, Omega]
         *           ThreeSet:  x.add("Beta") x.add("Alpha") x.add("Omega") => [Alpha, Beta, Omega] >> Alphabethische Reihenfolge
         * 
         */
        ...
        /*Weitere Anmerkungen: 
         * 
         * 1) Collection erbt von Iterable 
         * 2) Iterable hat iterator
         */
