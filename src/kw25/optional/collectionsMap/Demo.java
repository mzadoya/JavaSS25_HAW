...
public class Demo {
    ...
    public static void main(String[] args) {
         ...
         * Allgemein
         * 
         * 1) Map erbt von Collection nicht, aber ist ein Teil von Collection API 2)
         * Typparametern (also Map --> <String, Integer> <-- im Beispiel, können ganz
         * beliebig sein, also <Integer, String> usw..., ABER! nur 2! Map<String,
         * Integer, Integer> oder mehr geht nicht! 3) Keys sind einzigartig -- die
         * Duplikate mit dem gleichen Key wird ersetzt mit dem neuen (s. Kommentar z.
         * 28-32)
         */
        ...
        // leider aufgrund einer Tippfehler oder aus Versehen KA hat Prof falsche NOte
        // dem Student Maksym zugewiesen.

        students.put("Maksym", 100);

        /*
         * Falls man das gleiche Key nochmal benutzt, werden die zuvor zugewiesene
         * diesem Key Elemente ersetzt bzw. überschrieben mit neuen, da wie gesagt --
         * Map erlaub Duplikaten NICHT
         */
        ...
        // genauso funktionier mit TreeMap, der Unterschied ist halt nur, dass die
        // sortiert werden (vllt. s. CollecionSet)
